...
+ (NSString *)generateRandomNote
{
	...
	for (int i = 0; i < words; i++) {
		...
		NSString *randomWord = (instance.wdArray)[i];
...
+ (NSString *)generateRandomTitle {
	...
	NSString *randomWd = (instance.wdArray)[wdRandNumber];
	NSString *randomFn = (instance.fnArray)[fnRandNumber];
	NSString *randomLn = (instance.lnArray)[lnRandNumber];
...
+ (NSString *)generateRandomStreet
{
	...
	NSString *randomSn = (instance.snArray)[snRandNumber];
...
+ (NSString *)generateRandomCity
{
	...
	return (instance.cities)[cityRandNumber];
}
...
+ (NSString *)generateRandomState
{
	...
	return (instance.states)[stateRandNumber];
}
...
+ (NSArray *)generateRandomDaysOfTheMonth {
    NSMutableArray *array = [NSMutableArray array];
    for (int i = 0; i < 31; i++) {
        if (rand() % 10 == 0) [array addObject:@(i+1)];
    }
    return array;
}
...
+ (NSArray *)generateRandomMonthsOfTheYear {
    NSMutableArray *array = [NSMutableArray array];
    for (int i = 0; i < 12; i++) {
        if (rand() % 5 == 0) [array addObject:@(i+1)];
    }
    return array;
}
...
+ (NSArray *)generateRandomDaysOfTheYear {
    NSMutableArray *array = [NSMutableArray array];
    for (int i = 0; i < 366; i++) {
        if (rand() % 20 == 0) [array addObject:@(i+1)];
    }
    return array;
}
